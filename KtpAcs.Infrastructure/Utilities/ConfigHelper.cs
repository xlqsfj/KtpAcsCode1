...
namespace KtpAcs.Infrastructure.Utilities
{
    public class ConfigHelper
    {
        ...
        ///     开太平登录对接返回的项目id
        /// </summary>
        public static string KtpLoginProjectId
        {
        ...
        /// </summary>
        /// 
        public static string _KtpLoginPhone;
        public static string KtpLoginPhone
        {
            get { return _KtpLoginPhone; }
            set { _KtpLoginPhone = value; }
        }
        ...
        ///     开太平登录对接返回的项目id
        /// </summary>
        public static string _KtpLoginProjectId;
