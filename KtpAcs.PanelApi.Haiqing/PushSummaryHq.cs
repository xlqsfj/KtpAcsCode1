...
namespace KtpAcs.PanelApi.Haiqing
{
    ...
    public class PushSummaryHq
    {
        ...
        public PushSummaryHq(bool success, string message)
        {
            this.Message = "";
        ...
        /// <param name="success"></param>
        /// <param name="message"></param>
        public PushSummaryHq(bool success, string message, ApiType appType, RichRestRequest request, string apiName,int  state=200)
        {
            this.Message = "";
            this.Success = success;
        ...
        /// 无数据传输的推送结果
        /// </summary>
        public static PushSummaryHq NoDataResult
        {
            get { return new PushSummaryHq(true, "没有数据要传输。"); }
        }
